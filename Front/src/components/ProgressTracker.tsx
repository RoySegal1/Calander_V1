...
//   const { credits, gpa, completedRequirements } = mockUser;
//
...
//             {completedRequirements.mandatory}
//           </div>
...
//           </div>
//           <div className="text-xl font-bold text-blue-600">
//             {completedRequirements.elective}
//           </div>
//           <div className="text-xs text-gray-500">Credits Completed</div>
//         </div>
//
