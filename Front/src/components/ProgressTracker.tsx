  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6 space-y-6">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-xl font-semibold text-gray-800"> הנה ההתקדמות האקדמית שלך {user.name} שלום </h2>
      </div>

      {/* Credits Progress */}
      <div>
        <div className="flex justify-between mb-2">
          <span className="text-sm font-medium text-gray-700">נקודות זכות שצברת</span>
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="p-4 bg-red-100 rounded-lg">
          ...
          <div className="text-xs text-gray-500">נקודות זכות שהושלמו</div>
        </div>
      ...
      <p className="text-sm text-gray-500 mt-4">
        צפה בהתקדמות התואר שלך עבור {user.department || 'המחלקה שלך'}
      </p>
    </div>
  );
}
